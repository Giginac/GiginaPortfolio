  ...
  return (
    <div className="relative overflow-hidden min-h-[550px] sm:min-h-[660px] flex flex-col">
      ...
      <div 
        ...
        absolute rounded-full transform rotate-11 top-8
      ...
      >
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center" id="Home">
          ...
          <div className="relative lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 
            ...
            <div className="flex justify-center">
              <a 
                ...
                focus:outline-none hover:bg-blue-500 rounded-full text-lg
          ...
          >
            <img
              className="object-cover object-center rounded-full w-80 h-90 border-2 border-white shadow-xl"
              alt="Gigina - Frontend Developer"
              src={hero}
              width={320}
              height={320}
              loading="eager"
